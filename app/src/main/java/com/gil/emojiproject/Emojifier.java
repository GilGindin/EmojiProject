...
public class Emojifier {
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Log.d(TAG, "getClassifications: smilingprob = " + face.getIsLeftEyeOpenProbability());
        Log.d(TAG, "getClassifications: smilingprob = " + face.getIsRightEyeOpenProbability());
